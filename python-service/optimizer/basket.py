...
def optimize_basket(req: BasketRequest):
    ...
    plan = [
        (["ნედლი ხორცი", "ქათამი", "ღორი", "საქონელი", "ფარშრებული"], target_cal * 0.25, 100, 400),
        (["კვერცხი"], target_cal * 0.06, 50, 150),
        (["ყველი"], target_cal * 0.06, 50, 150),
        (["მარცვლეული და ბურღულეული"], target_cal * 0.15, 80, 300),
        (["მაკარონი"], target_cal * 0.10, 80, 250),
        (["პურ-ფუნთუშეული"], target_cal * 0.08, 100, 400),
        (["ბოსტნეული"], target_cal * 0.10, 100, 400),
        (["ხილი", "ციტრუსი"], target_cal * 0.06, 80, 300),
        (["კარაქი & სპრედი"], target_cal * 0.03, 20, 80),
        (["რძე & ნაღები", "მაწონი", "კეფირი & აირანი"], target_cal * 0.03, 80, 300),
    ]
