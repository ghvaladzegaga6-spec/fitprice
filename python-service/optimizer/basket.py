...
def optimize_basket(req: BasketRequest):
    ...
    plan = [
        (PROTEIN_CATS,          target_cal * 0.28, 100, 350),
        (DAIRY_CATS[:1],        target_cal * 0.07, 50,  200),  # კვერცხი
        (DAIRY_CATS[1:3],       target_cal * 0.06, 30,  150),  # ყველი/მაწონი
        (["მარცვლეული და ბურღულეული"], target_cal * 0.14, 80, 250),
        (["მაკარონი"],          target_cal * 0.09, 80,  200),
        (["პურ-ფუნთუშეული"],   target_cal * 0.07, 80,  350),
        (["ბოსტნეული"],         target_cal * 0.12, 100, 350),
        (["ხილი", "ციტრუსი"],  target_cal * 0.06, 80,  250),
        (FAT_CATS,              target_cal * 0.03, 15,  60),
        (DAIRY_CATS[3:],        target_cal * 0.03, 80,  250),  # რძე/კეფირი
    ]
